...
print('---------- Tempo do Semaforo --------\n')

velocidade = int(input('Digite a Velocidade Permitida na Via: '))
distancia = int(input('Digite o valor da Distância desde o Semáforo Anterior: '))
aceleracao = int(input('Digite a Aceleração do carro: '))

tempo = (distancia / velocidade) * 3.6

print(f'\n{tempo}s para que o semáforo abra.')